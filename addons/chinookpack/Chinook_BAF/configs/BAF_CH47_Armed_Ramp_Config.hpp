	...
	{
		author = "Deltagamer";
		model = "\Chinook_BAF\BAF_CH_47F_HC2_RAMP.p3d";
		...
		displayName = "RAF CH-47F HC2 (Ramp)";
		side = 1;
		faction = "BLU_F";
...
//				proxyIndex = 2;
        ...
        hiddenSelectionsTextures[]={"\data\ch47_ext_1_baf_co.paa", "\data\ch47_ext_2_baf_co.paa"};			
		animationList[]=
		{
			"DoorWinch_hide", 0,
		...
		class textureSources
		{
			class BAF_Green_Camo
			{
				...
				textures[]= 
				{
					"\data\ch47_ext_1_baf_co.paa", "\data\ch47_ext_2_baf_co.paa"
				};
				factions[]= 
				{
					"BLU_F", "BLU_G_F"
			...
			class Universal_OD_Green_Camo
			{
				...
				textures[]= 
				{
					"\data\ch47_ext_1_co.paa", "\data\ch47_ext_2_co.paa"
				};
				factions[]= 
				{
					"BLU_F", "BLU_G_F"
			...
			class Universal_Black_Camo
			{
				...
				textures[]=
				{
					"\data\Skins\Black\ch47_ext_1_SyNcRoNiCzZ_Black_co.paa", "\data\Skins\Black\ch47_ext_2_SyNcRoNiCzZ_Black_co.paa"
				};
				factions[]=
				{
					"BLU_F", "BLU_G_F"
			...
			class Universal_Grey_Camo
			{
				...
				textures[]= 
				{
					"\data\Skins\Grey\ch47_ext_1_SyNcRoNiCzZ_Grey_co.paa", "\data\Skins\Grey\ch47_ext_2_SyNcRoNiCzZ_Grey_co.paa"
				};
				factions[]=
				{
					"BLU_F", "BLU_G_F"
			...
			class Universal_Desert_Camo 
			{
				...
				textures[]= 
				{
					"\data\Skins\Desert\ch47_ext_1_CptDavo_Desert_co.paa", "\data\Skins\Desert\ch47_ext_2_CptDavo_Desert_co.paa"
				};
				factions[]= 
				{
					"BLU_F", "BLU_G_F"
		...
		{
		    init = "if (local (_this select 0)) then { [(_this select 0),[],true,[],[5,6,7,8]] call DEGA_fnc_deploySeats; }; [_this select 0] execVM ""data\Static_Parachute\scripts\static_line_init.sqf"";";
		};

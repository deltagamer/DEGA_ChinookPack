	...
	{
		author = "Deltagamer";
		model = "\Chinook_BAF\BAF_CH_47F_HC2_UNARMED.p3d";
...
*/		
		...
		{
		    init = "if (local (_this select 0)) then {[(_this select 0),[],true,[],[4,5,6,7]] call DEGA_fnc_deploySeats; }; [_this select 0] execVM ""data\Static_Parachute\scripts\static_line_init.sqf"";";		
		};			
